...
public class ResultAllAdapter extends ArrayAdapter<LevelWithProgress> {

    private Context context;

    public ResultAllAdapter(@NonNull Context context, int resource, @NonNull List<LevelWithProgress> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        View line = li.inflate(R.layout.style_result_level, parent, false);
